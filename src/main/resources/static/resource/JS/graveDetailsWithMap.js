...
info.update = function (props) {
   this._div.innerHTML = '<h4>কবর শনাক্তকরণ হয়নি</h4><b>আপনি কবর শনাক্তকরণে সহায়তা করতে চান?</b></br><button id="btny">Yes</button><button id="btnn">No</button>';
};
info.addTo(map);
