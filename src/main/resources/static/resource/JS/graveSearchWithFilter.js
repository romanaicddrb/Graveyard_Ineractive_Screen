...
console.log("hello");
    ...
    var myDataTable = $('#myDataTable').DataTable({
        language: {
            "emptyTable": "<img src='../resource/nodata.png' style='position: fixed; z-index: 1000; margin-left: 60%;'>",
...
//<!--                  },-->
            ...
            $('#searchBtn').on('click', function() {
                 ...
                 if(memoFilter!="" || deadNameFilter!=null || deadDayFilter!=null || deadMonthFilter!=null || deadYearFilter!=null || buriedDayFilter!=null || buriedMonthFilter!=null || buriedYearFilter!=null){
